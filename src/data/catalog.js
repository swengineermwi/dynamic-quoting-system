...
const WORKFLOW_MODULE_CATALOG = [
  ...
  },
  {
    ...
    code: 'CHAT',
    name: 'Internal Chat',
    description: 'Enables real-time communication between users and departments.',
    isOptional: true,
    isActive: true,
    tiers: [
      {
        ...
        lowCost: 5500,
        highCost: 7500,
        description: 'Basic 1-on-1 messaging',
      },
      {
        id: 'tier-chat-standard',
        tierName: 'Growth',
        lowCost: 7500,
        highCost: 11500,
        description: 'Group channels and file sharing',
      },
      {
        id: 'tier-chat-advanced',
        tierName: 'Enterprise',
        lowCost: 11500,
        highCost: 17500,
        description: 'Enterprise integrations, archiving, and advanced search',
      },
    ],
  },
];
...
const WORKFLOW_QUOTE_TEMPLATES = [
  {
    ...
    defaultModuleTierMap: {
      ...
      CHAT: { included: false, tier: 'Starter' },
    },
  },
  {
    ...
    defaultModuleTierMap: {
      ...
      CHAT: { included: true, tier: 'Enterprise' },
    },
  },
  {
